...
from expose.models.attention.supr.supr import SUPR

class SUPRLayer(SMPLX):
    def __init__(
        self,
        model_path: str,
        *args,
        **kwargs
        ...
        self.supr = SUPR(path_model='/Users/fga/Downloads/supr_male.npy', num_betas=10)
